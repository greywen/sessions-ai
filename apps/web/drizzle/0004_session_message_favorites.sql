...
--> statement-breakpoint
CREATE UNIQUE INDEX "idx_session_favorites_unique" ON "session_favorites" USING btree ("user_id","session_id");
--> statement-breakpoint
CREATE INDEX "idx_session_favorites_user" ON "session_favorites" USING btree ("user_id");
--> statement-breakpoint
CREATE INDEX "idx_session_favorites_session" ON "session_favorites" USING btree ("session_id");
--> statement-breakpoint
CREATE UNIQUE INDEX "idx_message_favorites_unique" ON "message_favorites" USING btree ("user_id","message_id");
--> statement-breakpoint
CREATE INDEX "idx_message_favorites_user" ON "message_favorites" USING btree ("user_id");
--> statement-breakpoint
CREATE INDEX "idx_message_favorites_message" ON "message_favorites" USING btree ("message_id");
